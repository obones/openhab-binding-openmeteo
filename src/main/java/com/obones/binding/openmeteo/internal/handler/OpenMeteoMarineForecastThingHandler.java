...
public class OpenMeteoMarineForecastThingHandler extends OpenMeteoBaseThingHandler {
    ...
    protected int getVariableIndex(String channelId) {
        return switch (channelId) {
            ...
            case CHANNEL_MARINE_FORECAST_SECONDARY_SWELL_WAVE_HEIGHT -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_TERTIARY_SWELL_WAVE_HEIGHT -> Variable.undefined; // fixme
            ...
            case CHANNEL_MARINE_FORECAST_SECONDARY_SWELL_WAVE_DIRECTION -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_TERTIARY_SWELL_WAVE_DIRECTION -> Variable.undefined; // fixme
            ...
            case CHANNEL_MARINE_FORECAST_SECONDARY_SWELL_WAVE_PERIOD -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_TERTIARY_SWELL_WAVE_PERIOD -> Variable.undefined; // fixme
            ...
            case CHANNEL_MARINE_FORECAST_OCEAN_CURRENT_VELOCITY -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_OCEAN_CURRENT_DIRECTION -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_SEA_SURFACE_TEMPERATURE -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_SEA_LEVEL_HEIGHT_MSL -> Variable.undefined; // fixme
            case CHANNEL_MARINE_FORECAST_INVERT_BAROMETER_HEIGHT -> Variable.undefined; // fixme
